...
>
  ...
  <xsl:template match="/">
    ...
    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:fox="http://xml.apache.org/fop/extensions">
      ...
      <fox:outline internal-destination="summary">
        <fox:label>Summary</fox:label>
      </fox:outline>
  ...
  <xsl:template match="resume">
            ...
            <xsl:when test="contact/phone/@type='h'">
              <fo:table-cell>
                <fo:block>Home:<xsl:text> </xsl:text></fo:block>
                  ...
                  <fo:table-cell>
                <fo:block>
                  <xsl:value-of select="contact/phone[@type='h']" />
                </fo:block>
              </fo:table-cell>
            </xsl:when>
            <xsl:otherwise>
            ...
            <xsl:when test="contact/phone/@type='m'">
              <fo:table-cell>
                <fo:block>Cell:<xsl:text> </xsl:text></fo:block>
                    ...
                    <fo:table-cell>
                <fo:block>
                  <xsl:value-of select="contact/phone[@type='m']" />
                </fo:block>
              </fo:table-cell>
            </xsl:when>
            <xsl:otherwise>
    ...
    available in <xsl:for-each select="online/formats/format">
